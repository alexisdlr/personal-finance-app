  ...
  return (
    <div className="text-sm md:mt-8 w-full flex justify-evenly md:flex-col">
      {menuItems.map(i => {
        ...
        return (
          <div className={`py-2 px-6 md:px-0 xl:px-6 lg:border-4 lg:border-transparent ${isActive ? " bg-beige-100 rounded-t-lg lg:rounded-t-none lg:rounded-tr-lg border-b-4 border-b-secondary-green md:border-b-0 lg:rounded-r-lg lg:border-s-4 lg:border-s-secondary-green" : ""}`} key={i.label}>
