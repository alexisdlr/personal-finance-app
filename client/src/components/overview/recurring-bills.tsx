  ...
  return (
    <div className="w-full h-full flex flex-col gap-3 justify-between">
      <div className="flex flex-col gap-4">
        <div className="flex flex-col gap-2 bg-beige-100 p-4 rounded-lg shadow-md border-l-2" style={{ borderColor: colors.paidBills }}>
        ...
        <div className="flex flex-col gap-2 bg-beige-100 p-4 rounded-lg shadow-md border-l-2" style={{ borderColor: colors.dueSoon }}>
          <div className="flex justify-between w-full py-2 px-4 " >
            <p className="text-grey-500">Due Soon:</p>
            <p className="text-black font-bold">${recurringData.dueSoon}</p>
          </div>
        </div>
        <div className="flex flex-col gap-2 bg-beige-100 p-4 rounded-lg shadow-md border-l-2" style={{ borderColor: colors.totalUpcoming }}>
          <div className="flex justify-between w-full py-2 px-4 " >
