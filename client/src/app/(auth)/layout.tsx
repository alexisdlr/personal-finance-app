...
export default function AuthLayout({
  ...
  return (
    <div className="bg-beige-100 h-screen w-full flex flex-col lg:flex-row text-black lg:p-4 overflow-y-hidden">
      ...
      <div className="w-full h-full rounded-xl overflow-hidden lg:w-[40%] flex items-center lg:justify-start lg:bg-auth lg:bg-cover lg:bg-top lg:relative">
        ...
        <Image src="/images/logo-large.svg" width={121} height={21} alt="logo" className="absolute top-8 left-6" />
        <div className="hidden 2xl:flex max-w-lg rounded-xl absolute bottom-6 left-2 p-2 w-full bg-black bg-opacity-85 text-white flex-col items-start justify-start">
