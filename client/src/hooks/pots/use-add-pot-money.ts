...
const useAddPotMoney = () => {
  ...
  return useMutation<PotMoneyResponse, Error, PotMoneyPayload>({
    ...
    onError: (error: Error) => {
      console.error("Error adding money to pot:", error.message);
    },
  });
};

export default useAddPotMoney;
